...
export default class App extends React.Component {
  ...
  setupWorld = () => {
    ...
    return {
      ...
      pipe1: { body: pipe1, size: [Constants.PIPE_WIDTH, pipe1Height], color: 'lightgreen', renderer: Wall },
      pipe2: { body: pipe2, size: [Constants.PIPE_WIDTH, pipe2Height], color: 'lightgreen', renderer: Wall },
      pipe3: { body: pipe3, size: [Constants.PIPE_WIDTH, pipe3Height], color: 'lightgreen', renderer: Wall },
      pipe4: { body: pipe4, size: [Constants.PIPE_WIDTH, pipe4Height], color: 'lightgreen', renderer: Wall }
    }
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        <GameEngine ref={(ref) => { this.GameEngine = ref; }} style={styles.gameContainer} systems={[Physics]} entities={this.entities} running={this.state.running} onEvent={this.onEvent} />
